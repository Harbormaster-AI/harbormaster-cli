...
module.exports = {
	...
	list: (filter, category, industry) => {
		return new Promise(function(resolve, reject) {
			const endpoint = 'marketplaceModelsView';
			var body = "category=" + category + "&industry=" + industry;
			if ( filter != undefined )
    ...
    categories: () => {
		return new Promise(function(resolve, reject) {
			const endpoint = 'domainModelCategories';
			var body = "";
    ...
    industries: () => {
		return new Promise(function(resolve, reject) {
			const endpoint = 'domainModelIndustries';
			var body = "";
	...
	profile: (id) => {
		return new Promise(function(resolve, reject) {
			const endpoint  = 'inspectModelView';
			const body      = "modelId=" + id;

			return requestHandler.handleRequest( endpoint, body, function(err, data) {
				if ( err ) {
		    		reject( status.error(err,
							util.format(constants.COMMAND_ERROR, constants.MODEL_PROFILE_REQUEST_MSG) ));
		    	}else {
		    		resolve( data );
		    	}
			}, false);
...
/*	validate: (file, javaRootPackageNames, primaryKeyPattern) => {
	...
	register: (modelFilePath, modelName, scope, javaRootPackageNames, primaryKeyPattern ) => {
		...
		return new Promise(function(resolve, reject) {
			...
			if ( modelFilePath != null ) {	
				...
				var saveParams 			= {"name":modelName, "description":"Directly loaded model file"};
